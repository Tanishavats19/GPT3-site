...
const WhatTest = () => {
  return <div className='test__whatgpt3 section__margin' id='wgpt3'>
    <div className='test__whatgpt3-feature'>
    ...
    <div className='test__whatgpt3-heading'>
      <h1 className='gradient__text'>The possibilities are beyond your imagination</h1>
      <p>Explore the Library</p>
    </div>
    <div className='test__whatgpt3-container'>
